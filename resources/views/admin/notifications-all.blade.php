...
<head>
    ...
    <title>All Notifications - MJ's Pharmacy</title>
...
<nav class="nav-bar">
    <div class="nav-links">
        ...
        <a href="{{ route('pos.index') }}" class="nav-button pos-button">POS</a>
        <a href="{{ route('orders.index') }}" class="nav-button">Orders</a>
        <a href="{{ route('products.index') }}" class="nav-button">Products</a>
        <a href="{{ route('inventory.index') }}" class="nav-button">Inventory</a>
        <a href="{{ route('sales.index') }}" class="nav-button">Sales</a>
        <a href="{{ route('customer.index') }}" class="nav-button">Customer</a>
        <a href="{{ route('suppliers.index') }}" class="nav-button">Suppliers</a>
        <a href="{{ route('reports.index') }}" class="nav-button">Reports</a>
    </div>

    <div class="header-actions">
        <div class="nav-button-wrapper">
            <a href="{{ route('chat.index') }}" class="nav-button-chat">🗨️</a>
