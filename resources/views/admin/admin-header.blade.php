                    ...
                    notificationElement.onclick = async (e) => {
                        ...
                        if (notification.unread) {
                            ...
                            if (success) {
                                ...
                                const unreadIndicator = notificationElement.querySelector(
                                    '.unread-indicator');
                                if (unreadIndicator) {
                                    unreadIndicator.remove();
                                }

                                const content = notificationElement.querySelector(
            ...
            window.markAllAsRead = async function() {
                try {
                    ...
                    if (response.ok) {
                        ...
                        console.error('Failed to mark all notifications as read:', response.status, response
                            .statusText);
